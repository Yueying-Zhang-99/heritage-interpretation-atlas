...
- Timeline：横轴年份、纵轴工作性主题聚类；紧凑圆点可在桌面宽度内总览。圆点旁常显英文短标题与机构/作者，点击查看含完整英中标题与内容摘要的详情。点大小为 1–3 级初步理论贡献编码，虚线圈表示待精读。
...
Timeline 按年份与可编辑主题显示筛选后的条目，不根据未经校核的关系画线。Network 保留筛选结果及其相邻辅助节点，不会通过连线重新引入被筛掉的文献。未连接的文献仍显示为孤立节点。关系下拉菜单控制连线类型；悬停连线可见证据说明。
